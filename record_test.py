...
class ArgsRecordTest(db_test.DbTest):
    ...
    def test_single_arg(self):
        ...
        self.assertEqual('foo', args[0].function_name)
...
class AssignRecordTest(db_test.DbTest):
    ...
    def test_single_assign(self):
        ...
        args = record.get_all_args()
        self.assertEqual(1, len(args.all()))
        self.assertEqual('record_test', args[0].module_name)
        self.assertEqual(109, args[0].lineno)
        self.assertEqual('a', args[0].var_name)
        self.assertEqual(
            '{}.str'.format(record.BUILTINS_NAME), args[0].type_name)
